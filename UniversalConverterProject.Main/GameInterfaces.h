...
public:
    ...
    WideChar const *GetTown();
    void SetTown(WideChar const *name);
    Int GetLongitude();
    Int GetLatitude();
...
public:
    ...
    UInt m_nSize;
    UInt m_nChecksum;
    UInt m_nNumLanguages;
    Int unk_0;
    WideChar m_szPath[260];

    CBinaryFile();
    ~CBinaryFile();
    Bool Open(WideChar const *filename, void *compressor = nullptr);
    Bool Close();
    WideChar const *GetPath();
    UChar GetNumLanguages();
    UInt GetSize();
    UInt GetVersion();
    UInt GetCurrentPos();
    ...
    void Skip(UInt size);
    UInt CalcChecksum();
    Bool IsVersionGreaterOrEqual(UInt year, UInt build);
    Char ReadChar();
    Short ReadShort();
    Int ReadInt();
    Int64 ReadInt64();
    ...
    void ReadUChar(UChar *out);
    void ReadUShort(UShort *out);
    void ReadUInt(UInt *out);
    void ReadUInt64(UInt64 *out);
    ...
    void ReadUInt64(UInt64 &out);
    void ReadFloat(Float &out);
    void ReadCharArray(Char *out, UInt count);
    void ReadShortArray(Short *out, UInt count);
    void ReadIntArray(Int *out, UInt count);
    void ReadInt64Array(Int64 *out, UInt count);
    void ReadUCharArray(UChar *out, UInt count);
    void ReadUShortArray(UShort *out, UInt count);
    void ReadUIntArray(UInt *out, UInt count);
    void ReadUInt64Array(UInt64 *out, UInt count);
    Bool ValidateFourcc(UInt value);
    void ReadString(WideChar *out, UInt maxLen);
    void ReadString(Char *out, UInt maxLen);
    void ReadTranslations(WideChar *out, UInt maxLen, UInt language);
    UInt ReadMem(void *out);
    Bool ReadAndValidateMem(void *out, UInt size);
};
...
public:
    ...
    UInt m_nErrorType;
    UChar field_C;
    Bool m_bSizeValidationUsed;
    Char m_szErrorMessage[256];
    Char _pad[2];

    CDBLoad(FILE *file);
    void Init(Bool sizeValidationUsed);
    UInt GetVersion();
    void SetVersion(UInt version);
    void SetError(Char const *errorText, UInt errorType);
    UInt GetErrorType();
    Char const *GetErrorMessage();
    void Read(void *out, UInt size, UInt count, FILE *file);
    void Skip(UInt size);
    void ReadInt64Array(Int64 *out, UInt count);
    void ReadIntArray(Int *out, UInt count);
    void ReadShortArray(Short *out, UInt count);
    ...
    void ReadUShortArray(UShort *out, UInt count);
    void ReadUCharArray(UChar *out, UInt count);
    void ReadBoolArray(Bool *out, UInt count);
    void ReadFloatArray(Float *out, UInt count);
    void ReadDoubleArray(Double *out, UInt count);
    void ReadInt64(Int64 *out);
    void ReadInt(Int *out);
    void ReadShort(Short *out);
    void ReadChar(Char *out);
    ...
    void ReadDate(CJDate *out);
    void ReadNameDesc(NameDesc *out);
    ...
    Double ReadDouble();
    Float ReadFloat();
    UInt ReadMem(void *out, UInt maxSize);
    void ReadString(WideChar *out, UInt maxLen);
    void ReadString(FmString &out);
    UInt ReadValidateMemsize();
};
...
public:
    ...
    CDBSave(FILE *file);
    void EnableSizeCheck(Bool enable);
    void Close();
    UInt GetVersion();
    void WriteInt64Array(Int64 value);
    void WriteInt64(Int64 value);
    void WriteIntArray(Int const *values, UInt count);
    void WriteInt(Int value);
    void WriteShortArray(Short const *values, UInt count);
    void WriteShort(Short value);
    void WriteCharArray(Char const *values, UInt count);
    void WriteChar(Char value);
    void WriteUInt64Array(UInt64 const *values, UInt count);
    void WriteUInt64(UInt64 value);
    void WriteUIntArray(UInt const *values, UInt count);
    void WriteUInt(UInt value);
    void WriteUShortArray(UShort const *values, UInt count);
    void WriteUShort(UShort value);
    void WriteUCharArray(UChar const *values, UInt count);
    void WriteUChar(UChar value);
    void WriteBoolArray(Bool const *values, UInt count);
    void WriteBool(Bool value);
    void WriteDate(CJDate date);
    void WriteDoubleArray(Double const *values, UInt count);
    void WriteDouble(Double value);
    void WriteFloatArray(Float const *values, UInt count);
    void WriteFloat(Float value);
    void WriteMem(void const *data, UInt size);
    void WriteNameDesc(NameDesc const &name);
    void WriteSize(UInt value);
    void WriteString(WideChar const *str);
    void WriteString(FmString const &str);
};
